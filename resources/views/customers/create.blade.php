<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between gap-3">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-lg font-bold text-dark">Tambah Pelanggan Baru</h2>
                    <p class="text-xs text-gray-400 hidden sm:block">Pendaftaran data petani atau pelanggan toko</p>
                </div>
            </div>
            <div class="hidden sm:flex items-center gap-2">
                <a href="{{ route('customers.index') }}" class="px-4 py-2 text-xs font-semibold text-gray-600 bg-white hover:bg-gray-50 rounded-xl border border-gray-200 transition-colors shadow-2xs">
                    Batal
                </a>
                <button type="submit" form="customer-create-form" class="btn-primary py-2 px-4 text-xs font-bold rounded-xl shadow-xs active:scale-95 transition-transform flex items-center gap-1.5">
    ...
    <div class="py-5 pb-24 max-w-2xl mx-auto">
        <div class="card-solid p-5 sm:p-6">
            <form id="customer-create-form" action="{{ route('customers.store') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="input-group-solid">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="Nama petani/pelanggan..."
                ...
                <div>
                    ...
                    <div class="input-group-solid">
                        ...
                        <textarea name="address" id="address" rows="3" placeholder="Nama dusun, desa, RT/RW..."
                ...
                <div class="pt-2 flex items-center justify-end gap-3 border-t border-gray-150">
                    <a href="{{ route('customers.index') }}" class="px-5 py-2.5 text-xs font-semibold text-gray-500 hover:text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-xl transition-colors">
                        Batal
                    </a>
