<x-app-layout>
    ...
    <div class="py-3 pb-24 max-w-lg mx-auto" x-data="posSystem()">
        ...
        <button @click="openCart = true" x-show="cart.length > 0" x-transition
                class="fab bg-primary-600 text-white flex items-center justify-center shadow-float">
            <div class="relative">
                🛒
                <span class="absolute -top-3 -right-3 bg-accent-500 text-white text-[10px] font-bold w-5 h-5 rounded-full flex items-center justify-center"
