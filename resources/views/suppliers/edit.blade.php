            ...
            <form action="{{ route('suppliers.update', $supplier) }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="input-group-solid">
                        ...
                        <input type="text" name="phone" id="phone" value="{{ old('phone', $supplier->phone) }}" placeholder="081..."
                               class="form-input-solid">
                    </div>
                </div>
                <div>
                ...
                <button type="submit" class="btn-primary w-full py-3 font-bold rounded-lg transition-transform active:scale-[0.98]">Perbarui Tengkulak</button>
            </form>
        </div>
    </div>
</x-app-layout>
