    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-lg font-bold text-dark">Tambah Pengguna Baru</h2>
                    <p class="text-xs text-gray-500">Buat akun untuk kasir atau administrator baru</p>
                </div>
            </div>
            ...
            <div class="hidden sm:flex items-center gap-2">
                ...
                <button type="submit" form="user-create-form" class="btn-primary py-2 px-4 text-xs font-bold rounded-xl flex items-center gap-1.5 shadow-sm active:scale-95 transition-transform">
    ...
    <div class="pb-24 pt-1 max-w-lg mx-auto md:max-w-none">
        <form id="user-create-form" action="{{ route('users.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 items-start">
                ...
                {{-- LEFT COLUMN: Preview & Status (4 cols on desktop) --}}
                <div class="lg:col-span-4 space-y-4 lg:sticky lg:top-20">
                    {{-- User Profile Placeholder Card --}}
                    <div class="card-solid p-5 space-y-4 bg-white text-center">
                        <div class="w-20 h-20 rounded-3xl mx-auto flex items-center justify-center bg-gray-100 text-gray-400 font-bold text-2xl border border-gray-200">
                            👤
                        </div>
                        <div>
                            <h3 class="text-base font-extrabold text-dark">Akun Baru</h3>
                            <p class="text-xs text-gray-400">Kasir atau Administrator</p>
                        </div>
                        ...
                        <div class="pt-3 border-t border-gray-150 flex items-center justify-between text-left">
                            <div>
                                ...
                                <p class="text-[10px] text-gray-400">Pengguna langsung dapat login</p>
                            </div>
                ...
                <div class="lg:col-span-8 space-y-4">
                    ...
                    <div class="card-solid p-5 space-y-4 bg-white">
                        <div class="flex items-center gap-2 border-b border-gray-150 pb-3">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] text-gray-400">Nama lengkap dan kontak login pengguna</p>
                            </div>
                        </div>
                    ...
                    <div class="card-solid p-5 space-y-4 bg-white">
                        <div class="flex items-center gap-2 border-b border-gray-150 pb-3">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] text-gray-400">Pilih tingkat wewenang akun pengguna</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <label class="cursor-pointer">
                                    <input type="radio" name="role" value="kasir" class="peer sr-only" {{ old('role', 'kasir') === 'kasir' ? 'checked' : '' }}>
                    ...
                    <div class="card-solid p-5 space-y-4 bg-white">
                        <div class="flex items-center gap-2 border-b border-gray-150 pb-3">
                            ...
                            <div>
                                <h3 class="text-sm font-bold text-dark">Kata Sandi</h3>
                                <p class="text-[11px] text-gray-400">Kata sandi awal untuk masuk ke aplikasi</p>
                            </div>
                        </div>
