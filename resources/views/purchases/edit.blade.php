...
<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-lg font-bold text-dark">Edit Pembelian Tengkulak</h2>
        </div>
    </x-slot>
                                            ...
                                            <select :name="'items['+index+'][product_id]'" 
                                                    x-init="
                                                        $nextTick(() => {
                                                            ...
                                                            if (item.productId) {
                                                                $($el).val(item.productId).trigger('change');
                                                            }
                                                        });
                                                    "
                                                    required
                                ...
                                <select name="supplier_id" id="supplier-select"
                                        x-init="
                                            $nextTick(() => {
                                                ...
                                                if (supplierId) {
                                                    $($el).val(supplierId).trigger('change');
                                                }
                                            });
                                        "
                                        required
                ...
                <div class="space-y-3 pt-2 border-t border-gray-150">
                    <div>
                        ...
                        <div class="input-group-solid">
                            ...
                            <input type="text" name="supplier_invoice_number" value="{{ old('supplier_invoice_number', $purchase->supplier_invoice_number) }}" placeholder="Masukkan nomor nota dari tengkulak..."
                                   class="form-input-solid">
                        </div>
                    </div>
                    <div>
            ...
            <div class="card-solid p-4 space-y-4">
                ...
                <div>
                    ...
                    <div class="input-group-solid">
                        ...
                        <textarea name="notes" rows="2" placeholder="Catatan transaksi..." class="form-input-solid h-auto py-2">{{ old('notes', $purchase->notes) }}</textarea>
                    </div>
                </div>
    ...
    <script>
        function purchaseForm() {
            return {
                ...
                additionalCost: {{ $purchase->additional_cost }},
                additionalCostNotes: '{{ $purchase->additional_cost_notes }}',
